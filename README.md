...
Make sure the instance has sufficient resources to run Jenkins and Docker.
...
For better security, restrict the source to your IP address where possible instead of allowing traffic from everywhere.
...
You can restart Jenkins using:

http://<EC2-PUBLIC-IP>:8080/restart

Alternatively, you can use the system service:
